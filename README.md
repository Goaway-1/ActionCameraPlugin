...
- 목차
1. 이 플러그인에 대해서 : (설명, Preview, 스토어링크)
2. 사용방법 (2D_FIX, 2D, 3D) :(Setup)
3. 동작원리 (2D_FIX, 2D, 3D)
...
- ## <span style = "color:yellow;">카메라 매니저의 설정</span>
  ...
  // 다시찍기 <////////img src="Image/SetReferenceScene.gif" height="300" title="SetReferenceScene">
...
> **<h3>Today Dev Story</h3>**
- ## <span style = "color:yellow;">자동 회전 기능</span>
